...
export const teachersData = [
  ...
  {
    id: 11,
    teacherId: "1234568890",
    name: "Ahmed Mosaad",
    email: "ahmed@mosaad.com",
    photo:
      "https://images.pexels.com/photos/2888150/pexels-photo-2888150.jpeg?auto=compress&cs=tinysrgb&w=1200",
    phone: "010030255654",
    subjects: ["Geography", "Art", "Music", "Literature"],
    classes: ["1B", "2A", "3C"],
    address: "123 Main St, Anytown, USA",
  },
];
...
// Updated calendar events to match the calendar display (August 04-08, 2025)
export const calendarEvents = [
  ...
  },
  {
    ...
    end: new Date(2025, 7, 6, 8, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 7, 6, 10, 0),
    end: new Date(2025, 7, 6, 10, 45),
  },

  {
    ...
    end: new Date(2025, 7, 6, 13, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2025, 7, 6, 14, 0),
    end: new Date(2025, 7, 6, 14, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2025, 7, 7, 9, 0),
    end: new Date(2025, 7, 7, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2025, 7, 7, 10, 0),
    end: new Date(2025, 7, 7, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2025, 7, 7, 11, 0),
    end: new Date(2025, 7, 7, 11, 45),
  },
